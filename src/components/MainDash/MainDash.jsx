...
const MainDash = ({ currentTab }) => {
	...
	async function WebSocketAPI() {
		...
		var token =
			"eyJhbGciOiJIUzUxMiJ9..iuVWhS1hB6AkQr57ZWchs8gYEhJnheeRlT385YAomewl2YmBCnfU2oxrj6OU7M5_tEH2jzOUMj2Zg_0E7EU4mg";
		...
		webSocket.onmessage = function (event) {
			...
			// console.log("Received Data:", received_msg?.data);
			// console.log("Hourly consumption Data:", received_msg?.data?.hourly_consumption_kWh[0][1]);
			...
			<div className="relative flex justify-between w-full">
				<div className="flex flex-col w-full gap-3">
					...
					<LiveData
						data={data}
						cost={cost}
						costLastUp={costLastUp}
						hourlyConsum={hourlyConsum}
						hourlyConsumLastUp={hourlyConsumLastUp}
						monthlyConsum={monthlyConsum}
						monthlyConsumLastUp={monthlyConsumLastUp}
						yearlyConsum={yearlyConsum}
						yearlyConsumLastUp={yearlyConsumLastUp}
					/>
				</div>
			</div>
